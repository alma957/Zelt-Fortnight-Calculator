...
for (let i = 0; i < params_arr.length; i++) {
   ...
   if (pair[0] === "type") {
    if (pair[1]==="director") {
      setDirector(true)
      inputState.employmentType="director"
      setInputState(inputState)
    } else {
      setDirector(false)
      inputState.employmentType="employee"
      setInputState(inputState)
    }
   }
  }
  ...
  return (
    ...
    <Box style={{display:"flex",flexDirection:dir,justifyContent:"flex-start","width":"99%"}}>
      ...
      />
      <FormControl size="small" style={{marginTop: "16px",marginLeft:"10px",width:"99%"}}>
      ...
      <FormControl style={{marginTop: "15px","width":"99%",marginLeft:"10px"}}>
      ...
      {/* <Box style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
       <Box style={{textAlign:"center",width:"99%",marginTop:"20px"}}>       
      ...
      <Box style={{display:"flex",flexDirection:dir,justifyContent:"flex-start","width":"99%",marginLeft:"0px"}}>
      <FormControl size="small" style={{marginTop: "15px","width":director?"99%":"33%",marginLeft:"2px"}}>
        ...
        size="small"
          inputProps={{}}
          input={<OutlinedInput label="Employment Type" style={{marginLeft:"10px"}} />}
          value={inputState.employmentType}
          style={{background: "white","width":"99%"}}
          onChange={e => {
            inputState.employmentType = e.target.value;
            if (inputState.employmentType=="employee") {
              setDirector(false)
            } else {
              setDirector(true)
            }
        ...
        <TextField
         ...
         onChange={(e)=>{
          ...
          const oneJan = new Date(2023,3,6);
          const endTax = new Date(2024,3,5)
         ...
         style={{display:director?"flex":"none" ,marginTop: "15px", background: "white","width":"99%",marginLeft:"10px"}}
         InputLabelProps={{
          shrink: true,
          style: {color: "black", fontWeight: "bold"},
        }}
        >
          ...
          <FormControl size="small" style={{display:director?"inline":"none",marginTop:"15px",width:"99%",marginLeft:"10px"}} >
        <InputLabel style={{color: "black", fontWeight: "bold",marginLeft:"0px"}} >
          Calculation method
        </InputLabel>
        <Select
        ...
        >
          <MenuItem value="standard">Regular</MenuItem>
